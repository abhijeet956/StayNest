export const faqOptionsList = [
    {
        head: "Is my place right for Hostel?",
        desc: "Hostel guests are interested in all kinds of places.We have listings for tiny homes, cabins, treehouses, and more.Even a spare room can be a great place to stay.",
        id: 1
    },
    {
    ...
    {
        head: "Any tips on being a great Hostel Host?",
    ...
    {
        head: "What are Hostel’s fees?",
        desc: "Hostel typically collects a flat service fee of 3% of the reservation subtotal when you get paid.We also collect a fee from guests when they book.In many areas, Hostel collects and pays sales and tourism taxes automatically on your behalf as well.",
        id: 5
    }
]